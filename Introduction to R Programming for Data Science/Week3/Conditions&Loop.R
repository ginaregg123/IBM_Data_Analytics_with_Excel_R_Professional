...
# we want to check a movie’s year, and print something if it greater than 2000
movie_year = 2002
...
# Print every value in length_min column
...
# while loop
# using while to print the first five movie names of our dataset
